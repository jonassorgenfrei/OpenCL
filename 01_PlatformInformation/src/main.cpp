...
int main(void)
{
    std::cout << "OpenCL Platforminformation - Version " << 
        PlatformInformation_VERSION_MAJOR << "." << PlatformInformation_VERSION_MINOR << std::endl;
    ...
    try {
        ...
        {
            // string buffer to write opencl information to
            std::string s;
